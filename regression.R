...
option_list <- list(
  ...
  optparse::make_option(c("-P", "--pcentfilter"), action = "store", type = 'numeric', dest = "pf", default = "0.3",
                        help = "Percentage of correlated gene/transcript pairs allowed in each iteration (numeric). Default: 0.3"),
  optparse::make_option(c("-V", "--varfilter"), action = "store", type = 'numeric', dest = "var", default = "0.01",
