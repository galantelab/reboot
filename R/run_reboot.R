...
#' @param data Data.frame. A data.frame containing survival data
#' (e.g., OS, OS.time) and expression values (genes or transcripts).
#' @param signature A \code{reboot_signature} object generated by
#' \code{rebootRegression()}, or a data.frame containing the molecular
#' signature with feature names and regression coefficients.
#' @param outprefix Character. Output prefix used for generated files (Default: \code{"reboot"}).
                           ...
                           log = FALSE)
{
  ...
  # Handles 2 scenarios: (I) signature from module I (regression); (II) R data.frame
